...
15. [Payroll Management](#payroll-management)
...
*   **Employee JSON Data (`employee` part)**:
    ```json
    {
      ...
      "annualCtc": "double (positive number, required)",
      "salaryStructureId": "long (id of the salary structure, required)",
      "empId": "string (unique)",
...
*   **Response**: `EmployeeResponse`
    ```json
    {
      ...
      "status": "WORKING",
      "dateOfJoining": "2024-01-01",
      "resume": "/uploads/resumes/uuid_resume.pdf",
      "employeeImage": "/uploads/images/uuid_photo.jpg",
      "provisionalCertificate": "/uploads/certificates/uuid_provisional.pdf",
      "degreeCertificate": "/uploads/certificates/uuid_degree.pdf",
      "aadharCard": "/uploads/aadhar/uuid_aadhar.pdf",
      "panCard": "/uploads/pan/uuid_pan.pdf",
      "sslcCertificate": "/uploads/certificates/uuid_sslc.pdf",
      "hscCertificate": "/uploads/certificates/uuid_hsc.pdf",
      "experienceCertificates": "/uploads/experience/uuid_exp.pdf",
      "experiences": [
        {
...
*   **Security**: Requires ADMIN role
*   **Description**: Creates a new salary structure template for a company. This defines how earnings and deductions are calculated relative to the CTC.
...
*   **Endpoint**: `GET /api/salary-structures/company/{companyId}`
*   **Security**: Requires ADMIN role
...
*   **Endpoint**: `GET /api/salary-structures/{id}`
*   **Security**: Requires ADMIN role
*   **Description**: Retrieves the details of a specific salary structure including all its components.
*   **Response**: `SalaryStructureResponse`
    ```json
    {
      "id": 1,
...
*   **Response**: `PayrollSummaryResponse`
    ...
    {
      "totalEmployees": 10,
      "totalGrossSalary": 813000.0,
      "totalDeductions": 103081.0,
      "netPayable": 709919.0,
      "processedCount": 10,
      "pendingCount": 0
    }
