...
*   **Security**: Requires ADMIN role
*   **Description**: Calculates and generates the payroll for an employee for a specific month/year based on their CTC and the company's default salary structure. 
